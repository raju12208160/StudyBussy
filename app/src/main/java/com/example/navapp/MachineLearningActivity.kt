...
class MachineLearningActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pdfAssetName = "machinelearning.pdf"  // Updated file name for Machine Learning PDF
        val pdfName = "machinelearning_pdf"  // Name to identify the PDF in the database
    ...
    private fun createTempPdfFile(pdfBytes: ByteArray): File? {
        return try {
            ...
            val tempFile = File.createTempFile("machinelearning_", ".pdf", cacheDir)
