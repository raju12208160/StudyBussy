...
class WebDevActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pdfAssetName = "web.pdf"  // Updated file name for Web Development PDF
        val pdfName = "web_pdf"  // Name to identify the PDF in the database
    ...
    private fun createTempPdfFile(pdfBytes: ByteArray): File? {
        return try {
            ...
            val tempFile = File.createTempFile("web_", ".pdf", cacheDir)
