...
class AndroidActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pdfAssetName = "android.pdf"  // Updated file name
        val pdfName = "android_pdf"  // Name to identify the PDF in the database
    ...
    private fun createTempPdfFile(pdfBytes: ByteArray): File? {
        return try {
            ...
            val tempFile = File.createTempFile("android_", ".pdf", cacheDir)
