...
class BlockChainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pdfAssetName = "blockchain.pdf"  // Updated file name for Blockchain PDF
        val pdfName = "blockchain_pdf"  // Name to identify the PDF in the database
    ...
    private fun createTempPdfFile(pdfBytes: ByteArray): File? {
        return try {
            ...
            val tempFile = File.createTempFile("blockchain_", ".pdf", cacheDir)
