...
class DsaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pdfAssetName = "Dsa.pdf"  // Corrected to match the exact case of the PDF in assets
        val pdfName = "dsa_pdf"  // Name to identify the PDF in the database
    ...
    private fun createTempPdfFile(pdfBytes: ByteArray): File? {
        return try {
            ...
            val tempFile = File.createTempFile("dsa_", ".pdf", cacheDir)
